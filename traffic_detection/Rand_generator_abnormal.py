...
class SDNRand (threading.Thread):
    ...
    def __init__(self,protocol,target):
    	...
    	PostStatsURL = "http://10.20.5.39:8080/stats/port/1/1"
	...
	while True:
            ...
            number_packets=random.randint(20,300)
            ...
            #file = open("data_set_normal2.txt", w)
            #subprocess.call(["curl", "http://10.20.5.39:8080/stats/port/1/1"])
            #file.write(data)
